...
{
   static XScuGic intc;
   static XGpio SWs_4Bits_Gpio;
   static XEmacPs ps7_ethernet_0;
   static XGpio BTNs_4Bits_Gpio;
...

   {
      ...
      print("\r\nRunning GpioInputExample() for SWs_4Bits...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_SWS_4BITS_DEVICE_ID, &DataRead);
   ...
   }
   {
      ...
      Status = GpioIntrExample(&intc, &SWs_4Bits_Gpio, \
                               XPAR_SWS_4BITS_DEVICE_ID, \
                               XPAR_FABRIC_SWS_4BITS_IP2INTC_IRPT_INTR, \
...

   {
      ...
      print("\r\nRunning GpioInputExample() for BTNs_4Bits...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_BTNS_4BITS_DEVICE_ID, &DataRead);
   ...
   }
   {
      ...
      Status = GpioIntrExample(&intc, &BTNs_4Bits_Gpio, \
                               XPAR_BTNS_4BITS_DEVICE_ID, \
                               XPAR_FABRIC_BTNS_4BITS_IP2INTC_IRPT_INTR, \
                               GPIO_CHANNEL1, &DataRead);
